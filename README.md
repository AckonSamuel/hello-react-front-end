...
- You can find the back-end app of this project using this [link](https://github.com/AckonSamuel/hello-rails-back-end)
...
```
  git clone https://github.com/AckonSamuel/hello-rails-front-end.git
